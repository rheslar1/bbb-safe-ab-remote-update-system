# BBB Safe A/B Remote Update System Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for BBB Safe A/B Remote Update System. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: BeagleBone Black update project that partitions eMMC into A/B OS slots, coordinates U-Boot health checks, and uses RAUC or Mender for rollback-safe remote updates. | Scenario tests and documentation review. |
