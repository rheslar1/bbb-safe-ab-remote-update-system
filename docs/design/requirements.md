...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for BBB Safe A/B Remote Update System. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: BeagleBone Black update project that partitions eMMC into A/B OS slots, coordinates U-Boot health checks, and uses RAUC or Mender for rollback-safe remote updates. | Scenario tests and documentation review. |
